...
void Graphics::DrawRect(const Vei2& point1, const Vei2& point2, const Color& color){
...
void Graphics::DrawRectDim(const Vei2& pos, int width, int height, const Color& color){
...
void Graphics::DrawCircle(const Vei2& center, int radius, const Color& color){
    DrawCircle(center.x, center.y, radius, color);
}


RectI Graphics::GetRect() const{
    return RectI( Vei2{ 0 , 0 }, window.GetWidth(), window.GetHeight());
}
